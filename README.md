...
- [System Architecture](#system-architecture)
  - [Simplified Architecture (Module Overview)](#simplified-architecture-module-overview)
  - [Detailed Architecture (Full System)](#detailed-architecture-full-system)
- [Supported Capabilities](#supported-capabilities)
  - [1. Voice Recognition](#1-voice-recognition)
  - [2. Natural Language Understanding](#2-natural-language-understanding)
  - [3. Relative Movement](#3-relative-movement)
  - [4. Vision Recognition](#4-vision-recognition)
  - [5. Context Management](#5-context-management)
  - [6. Error Handling](#6-error-handling)
- [Project Structure](#project-structure)
  - [Directory Descriptions](#directory-descriptions)
- [Hardware Environment](#hardware-environment)
  - [Robot Hardware Platform](#robot-hardware-platform)
  - [ROS2 Environment](#ros2-environment)
  - [System Requirements](#system-requirements)
- [Installation](#installation)
- [Usage](#usage)
  - [Running the Voice-Controlled System](#running-the-voice-controlled-system)
...
- [Execution Plan Format](#execution-plan-format)
  - [Supported Actions](#supported-actions)
  - [Predefined Locations (Configuration Values)](#predefined-locations-configuration-values)
  - [Coordinate System](#coordinate-system)
- [Key Features](#key-features)
  - [Automatic Home Positioning](#automatic-home-positioning)
  - [Context Preservation](#context-preservation)
  - [Smart Plan Generation](#smart-plan-generation)
  - [Bin/Drop-off Operations](#bindrop-off-operations)
- [Communication Protocol](#communication-protocol)
  - [Overview of Communication Methods](#overview-of-communication-methods)
  - [TCP Socket Communication (Primary Method)](#tcp-socket-communication-primary-method)
    - [Connection Details](#connection-details)
    - [Command Format (Client → Server)](#command-format-client--server)
    - [Response Format (Server → Client)](#response-format-server--client)
    - [Socket Server Setup on Raspberry Pi 4](#socket-server-setup-on-raspberry-pi-4)
  - [ROSBridge WebSocket Communication (Alternative Method)](#rosbridge-websocket-communication-alternative-method)
    - [How ROSBridge Works](#how-rosbridge-works)
    - [Advantages and Limitations](#advantages-and-limitations)
    - [Setup on Raspberry Pi](#setup-on-raspberry-pi)
    - [When to Use ROSBridge](#when-to-use-rosbridge)
